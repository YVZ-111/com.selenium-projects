...
public class LogInPage_01 {
    public static void main(String[] args) {
        ...
        WebElement userNameBox = driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_username\"]"));
        userNameBox.sendKeys("Tester");

        driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_password\"]")).sendKeys("asdfgh");
